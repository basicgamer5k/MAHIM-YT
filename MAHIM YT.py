...
\033[1;37m Owner   :             MAHIM YT
\033[1;37m Facebook:            Mahim Isla
\033[1;37m Github  :            basicgamer5k
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open 01980076703
        pass
    elif select =='F':
        os.system('  https://www.facebook.com/profile.php?id=61550898077705
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
